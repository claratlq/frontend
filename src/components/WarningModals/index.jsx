      ...
      {errorMessage != null && error ? (
        ...
        <div className="Error-Container">
          <div className="Error-Box">
            ...
            <p className="Error-Message">
              This will clear your existing chat and start a new session. Your
              current chat session will not be saved.
            </p>
            <div className="Button-Container">
              <button
                id="Reupload"
        ...
        <div className="Error-Container">
          <div className="Error-Box">
            ...
            <p className="Error-Message">
              Please clear your chat to start a new session. Your current chat
