              ...
              <div className="feedback-container">
                ...
                >
                  {selectup ? (
                    ...
                    >
                      <path
                        d="M26 29H16V16L23 9L24.25 10.25C24.3667 10.3667 24.4625 10.525 24.5375 10.725C24.6125 10.925 24.65 11.1167 24.65 11.3V11.65L23.55 16H29C29.5333 16 30 16.2 30.4 16.6C30.8 17 31 17.4667 31 18V20C31 20.1167 30.9875 20.2417 30.9625 20.375C30.9375 20.5083 30.9 20.6333 30.85 20.75L27.85 27.8C27.7 28.1333 27.45 28.4167 27.1 28.65C26.75 28.8833 26.3833 29 26 29ZM14 16V29H10V16H14Z"
                        fill="#525252"
                      />
                    </svg>
                  ) : (
                ...
                >
                  {selectdown ? (
                    ...
                    >
                      <path
                        d="M14 11H25V24L18 31L16.75 29.75C16.6333 29.6333 16.5375 29.475 16.4625 29.275C16.3875 29.075 16.35 28.8833 16.35 28.7V28.35L17.45 24H11C10.4667 24 10 23.8 9.6 23.4C9.2 23 9 22.5333 9 22V20C9 19.8833 9.01667 19.7583 9.05 19.625C9.08333 19.4917 9.11667 19.3667 9.15 19.25L12.15 12.2C12.3 11.8667 12.55 11.5833 12.9 11.35C13.25 11.1167 13.6167 11 14 11ZM23 13H14L11 20V22H20L18.65 27.5L23 23.15V13ZM25 24V22H28V13H25V11H30V24H25Z"
                        fill="#525252"
                      />
                    </svg>
                  )}
